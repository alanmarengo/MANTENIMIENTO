...
<div id="page_monitoreo" class="page page_template">
    <div class="row">
        ...
        <div class="col-md-12 section-b">
			...
			<iframe id="box4" src="./geovisor.redesbox.php" frameborder="0" style="overflow:hidden;height:200vh;width:100%" height="100%" width="100%"></iframe>
...
$(document).ready(function() {
    ...
    <?php //include("./slider_monitoreo.php"); ?>
