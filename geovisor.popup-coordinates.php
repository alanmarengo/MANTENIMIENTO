<div class="popup popup-dark" id="popup-coordinates">
			...
			<div class="nav navbar-expand popup-nav popup-nav-right">
				...
				<ul class="navbar-nav">
					<li class="nav-item nav-item-button popup-header-li active">
						<a class="popup-header-button" href="#" onclick="$('#popup-coordinates').hide();">
							<span>X</span>
						</a>
					</li>
				</ul>
	...
	<?php include("./geovisor.popup-coordinates-basic.php"); ?>
