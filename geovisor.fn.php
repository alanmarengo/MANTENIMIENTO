...
function DrawLayers($clase_id) {			
	...
	$query_string = "SELECT DISTINCT clase_id,layer_id,tipo_layer_id,layer_desc,layer_wms_layer,layer_wms_server FROM mod_geovisores.vw_layers WHERE clase_id = " . $clase_id . " ORDER BY layer_desc ASC";
		...
		<div class="layer-group" data-state="0" data-layer="<?php echo $r["layer_id"]; ?>" data-cid="<?php echo $r["clase_id"]; ?>" data-layer-type="<?php echo $r["tipo_layer_id"]; ?>">
			...
			<div class="layer-body">
				...
				<div class="layer-icons">
					...
					<div class="layer-icon" id="layer-icon-zoomext-<?php echo $r["layer_id"]; ?>" onclick="geomap.map.zoomToLayerExtent(<?php echo $r["layer_id"]; ?>);" title="Ir a extent de capa">
						<a href="javascript:void(0);">
