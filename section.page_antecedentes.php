...
<div id="page_antecedentes" class="page page_template">
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p>
                        ...
                        <br />
                        <span class="bullet">•</span>Se sextuplicó la capacidad de erogación de los descargadores de fondo, asegurando que aun durante el desvío del río, llenado del embalse y en épocas de aguas bajas se garantice la regularidad del ciclo hidrológico para la sostenibilidad ambiental.
                    </p>
                </div>
            </div>

            <br />
            <h3 style="font-size: 14px;">OPERACI&Oacute;N DE "BASE" DE LA BARRANCOSA</h3>

            <div class="row">
                <div class="col-md-6">
                    <p>La operación de “base” de una central hidroeléctrica consiste en un funcionamiento permanente de la misma, de modo tal que su embalse no cumple la función de reservar el agua para generar electricidad en los momentos de mayor demanda.</p> 
                    <p>En el caso de las obras sobre el río Santa Cruz, la función de “base” la cumple la central La Barrancosa (situada aguas abajo de la presa Cóndor Cliff), que también tendrá un criterio de operación adicional: la central debe erogar el mismo caudal diario que ingresa al río Santa Cruz desde el lago Argentino. Por lo cual el tramo fluvial que quedará aguas abajo de La Barrancosa no tendrá las fluctuaciones típicas de los ríos con aprovechamientos hidroeléctricos, sino que respetará los caudales naturales del río.</p>
                    <p>De esta manera, si nos ubicamos en cualquier punto aguas abajo de la presa La Barrancosa durante la etapa de operación (incluyendo la zona del estuario) el río se comportará de la misma forma que si ambas obras no existieran. Es decir que en esta zona el río tendrá las mismas fluctuaciones a lo largo del día y de las estaciones que tendría si las obras no hubieran sido construidas, evitando que se produzcan alteraciones hidrológicas.</p>
                    <p>Desde el punto de vista energético, ello constituye una restricción a la generación, priorizando la preservación ambiental de la porción inferior del río, del estuario y su fauna. Por lo tanto, La Barrancosa podrá generar sólo la cantidad de energía que le permita el caudal medio del río.</p>
                    <p>La reducción del número de turbinas en La Barrancosa, de 5 a 3, es una modificación que acompaña al nuevo régimen de operación de la central.</p> 
                </div>
                <div class="col-md-6">
                    <p>
                        <b>Reducción del nivel de embalse de la presa Cóndor Cliff</b>
                        <img src="./images/base1.png" style="margin: 1em 0em 1em 0em; width: 90%; height: auto;" />

                        <b>Operación de “base” de La Barrancosa</b>
                        <img src="./images/base2.png" style="margin: 1em 0em 1em 0em; width: 90%; height: auto;" />
                    </p> 
                </div>
        ...
        <div class="col-md-12 section-a estudio">
            ...
            <p>El Estudio cumplimentó lo solicitado en el mencionado dictamen de la Corte, conjuntamente con la realización de la Audiencia Pública en el marco del Congreso de la Nación, desarrollada el 20 y 21 de julio de 2017.</p>
            <p>
                Buenos Aires, 20 y 21 de julio de 2017
