...
function draw_grafico_12(container,config) { // PIE WITH DRILLDOWN
	...
	container.innerHTML = "<h3 style='font-size:20vw; margin:0; color:#0088cc;'>"+config.data[0].y + "</h3>";
	container.innerHTML += "<h4 style='font-size:5vw; margin:0;'>"+ config.unidad + "</h4>";
	container.innerHTML += "<h5 style='font-size:5vw; margin:10px 0;'>"+config.titulo+"</h5>";
