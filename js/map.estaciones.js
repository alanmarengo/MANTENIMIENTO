    ...
    this.map.create = function() {
        ...
        this.popupTab1 = function() {
            ...
            for (var i = 0; i < js.categoria_parametros.length; i++) {
                ...
                html += `
                <div class="category">
                    <input ${checked} type="radio" name="categoria" checked="checked" value="${js.categoria_parametros[i].categoria_parametro_id}" onclick="geomap.map.current_categoria_id=this.value">
